                    ...
                    <tbody>
                        ...
                        @forelse ($pesanan_details as $pesanan_detail)
                            <tr>
                                ...
                                <td align="right"><strong>Rp. {{ number_format($pesanan_detail->total_harga) }}<strong>
                                </td>
                                <td><i wire:click="destroy({{ $pesanan_detail->id }})"
                        ...
                        @if (!empty($pesanan))
                            <tr>
                                ...
                                <td align="right"><strong>Rp. {{ number_format($pesanan->total_harga) }}</strong>
                                </td>
                            </tr>
                            <tr>
                            ...
                            <tr>
                                ...
                                <td align="right"><strong>Rp.
                                        {{ number_format($pesanan->total_harga + $pesanan->kode_unik) }}</strong>
                                </td>
                            </tr>
                            <tr>
                                <td colspan="6"></td>
                                <td colspan="2">
                                    <a href="{{ route('checkout') }}" class="btn btn-success btn-block">Checkout <i
